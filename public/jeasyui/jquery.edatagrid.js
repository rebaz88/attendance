...
(function($){
	...
	function buildGrid(target){
		...
		$(target).datagrid($.extend({}, opts, {
			onDblClickCell:function(index,field,value){
				if (opts.preventDoubleClickCellEditing){
		      return; //added by Rebaz to prevent double click edit
		    }
				if (opts.editing){
	...
	$.fn.edatagrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		singleSelect: true,
		preventDoubleClickCellEditing: false, // Added by Rebaz to prevent double click editing
		editing: true,
		editIndex: -1,
		destroyMsg:{
			norecord:{
